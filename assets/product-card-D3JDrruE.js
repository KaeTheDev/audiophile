import{c as l}from"./footer-CLAYWvaQ.js";function _(e,t=0){const c=document.createElement("article"),s=t%2!==0;c.className=`product-card${s?" product-card--reverse":""}`;const a=`/audiophile/assets/product-${e.slug}`,r=["xx99-mark-one-headphones","yx1-earphones","zx9-speaker"].includes(e.slug)?"png":"jpg",n=`${a}/desktop/image-category-page-preview.${r}`,i=`${a}/tablet/image-category-page-preview.${r}`,d=`${a}/mobile/image-category-page-preview.${r}`;c.innerHTML=`
