import{a as p,c as r,b as m,g as u}from"./footer-CLAYWvaQ.js";import{G as g}from"./back-btn-D-r1veg2.js";function y(e){const t=document.createElement("div");t.classList.add("product-detail-container");const a=g(),n=document.createElement("section");n.classList.add("product-detail");const s=l=>`/audiophile/assets/product-${e.slug}/${l}/image-product.jpg`;n.innerHTML=`
