import{c as p}from"./cart-modal-e94tEmip.js";function u(e,t=0){const c=document.createElement("article"),o=t%2!==0;c.className=`product-card${o?" product-card--reverse":""}`;const a=`/audiophile/assets/product-${e.slug}`,s=`${a}/desktop/image-category-page-preview.jpg`,n=`${a}/tablet/image-category-page-preview.jpg`,i=`${a}/mobile/image-category-page-preview.jpg`;c.innerHTML=`
