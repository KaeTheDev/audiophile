...
`;function C({label:e,variant:n="primary",type:r="button",icon:l=""}){const t=document.createElement("button");return t.className=`btn btn--${n}`,t.type=r,t.innerHTML=`
  ...
  `,t}function M(){const e=document.createElement("div");e.id="cart-modal",e.className="cart-modal";function n(){const{items:r,total:l}=k();e.innerHTML=`
...
`;const t=e.querySelector(".cart-modal__items");r.forEach(o=>t.appendChild(N(o))),e.querySelector(".cart-modal__remove-all").addEventListener("click",y);const a=C({label:"Checkout",variant:"primary"});a.addEventListener("click",()=>{window.location.href="checkout.html"}),e.querySelector(".cart-modal__checkout").appendChild(a)}return n(),document.addEventListener("cart:updated",n),e}function A(){const e=document.createElement("footer");return e.className="footer",e.innerHTML=`
  ...
  `,e}export{M as C,A as F,w as N,L as a,S as b,C as c,$ as d,O as e,x as f,k as g,y as h};
